...
from qgis.core import QgsProject, Qgis, QgsCoordinateFormatter


# Initialize Qt resources from file resources.py
from .resources import *
# Import the code for the dialog
from .set_location_dialog import SetLocationDialog
import os.path
...
class SetLocation:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&SetLocation')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SetLocation', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/set_location/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Set Locations as CSV'),
            callback=self.run,
